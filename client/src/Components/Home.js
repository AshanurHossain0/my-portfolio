        ...
        <div className='flex gap-4'>
          ...
          <div className=' flex flex-col justify-between p-2'>
            <div>
              ...
              <p className='text-2xl md:text-3xl'>A Passionate <span className='text-purple-900'>Fullstack</span></p>
              <p className='text-2xl md:text-3xl'><span className='text-purple-800'>Developer</span> from India</p>
